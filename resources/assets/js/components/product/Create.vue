          ...
          <div id="collapse2" class="body">
            <form class="form-horizontal" id="popup-validation" @submit.prevent="create">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                    <!-- <textarea class="form-control" rows="8" cols="80" name="intro" id="intro" v-model="product.intro"></textarea> -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                    <!-- <textarea class="form-control" rows="8" cols="80" id="contents" v-model="product.content"></textarea> -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                    ...
                    <span class="text-danger">{{errors.keywords ? errors.keywords[0] : ''}}</span>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    create: function create() {
      axios.post('/api/product/store', this.product)
      .then(response => {
